...
public class UserDB {
	...
	public boolean save(){
		this.racine = new Element("UserDB");//nous sommes oblig� de cr�er une nouvelle base lors de la sauvegarde, pour ne pas avoir de doublon ou de garder les �l�ments supprim�...
		this.document = new Document(racine);
